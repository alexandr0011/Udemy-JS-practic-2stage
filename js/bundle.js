        ...
        elements.forEach(element => {
            element.addEventListener('click', (elem) => {
                if (elem.target.getAttribute('data-ratio')) {
                    ...
                    localStorage.setItem('ratio', +elem.target.getAttribute('data-ratio'));
                } else {
...
/* harmony export */ });
function slider({container, slide, nextArrow, prewArrow, totalCounter, currentCounter, wrapper}) {
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__.timer)('.timer', '2022-03-25');
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.modal)('[data-modal]', '.modal');
    (0,_modules_cards__WEBPACK_IMPORTED_MODULE_3__.cards)();
    (0,_modules_forms__WEBPACK_IMPORTED_MODULE_4__.forms)('form');
    ...
    (0,_modules_calc__WEBPACK_IMPORTED_MODULE_6__.calc)();    
